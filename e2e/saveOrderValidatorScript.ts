...
import { authenValidatorScript, NETWORK_ID, orderValidatorScript, poolBatchingValidatorScript, poolValidatorScript, txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1Utxos } from "./setup.js";
...
console.log('save order script tx Hash:', txHash);
