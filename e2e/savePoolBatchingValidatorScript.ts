...
import { authenValidatorScript, NETWORK_ID, poolBatchingValidatorScript, txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1Utxos } from "./setup.js";
...
const unsignedTx = await txBuilder
    .txOut(refAddress, [])
    .txOutReferenceScript(poolBatchingValidatorScript, "V3")
...
console.log('save pool batching script tx Hash:', txHash);
