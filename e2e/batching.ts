...
const poolBatchingScriptTxHash =
  "41af8cc69697cbc31a1657a6a45bd1b635080defa6675ffc51925d7888f154c6";
const poolBatchingScriptTxIndex = 0;
// pool ref script
const poolScriptTxHash =
  "0c27db9565223a1949c93da5ab33a70e46f71b6e83e002935b84c81a60447fb1";
const poolScriptTxIndex = 0;
// order ref script
const orderScriptTxHash =
  "a02cd47881abcb1b422ee1c4fae9739d0963fc6c6f25774d0171d0e9a00830d5";
...
const updatedIMyTokenTwoSupply =
  oldPoolDatum.fields[4].int + BigInt(swapAmount);
const updatedMyTokenOneSupply =
  oldPoolDatum.fields[5].int - BigInt(assetBAmount);
...
const invalidBefore = unixTimeToEnclosingSlot(Date.now() - 50000, SLOT_CONFIG);
...
const unsignedTx = await txBuilder
  ...
  .txOut(poolValidatorAddress, [
    ...
    {
      unit: alwaysSuccessMintValidatorHash + stringToHex("iMyTokenTwo"),
      quantity: String(updatedIMyTokenTwoSupply),
    },
    {
      unit: alwaysSuccessMintValidatorHash + stringToHex("myTokenOne"),
    ...
    {
      unit: authenPolicyId + lpAssetName,
      quantity: String(remainingLiquidity),
    },
