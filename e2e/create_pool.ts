...
const authenScriptTxHash =
  "7901cfdd1ea6e6bf9db662976f1fc120e50514a87b1b3ff327b189ec08037279";
...
const factoryRedeemer = mConStr0([assetA, assetB]);
...
const factoryDatum1 = mConStr0(["00", lpAssetName]);
...
const unsignedTx = await txBuilder
  ...
  .txOut(poolValidatorAddress, [
    { unit: "lovelace", quantity: "4500000" },
    {
      ...
      quantity: String(iMyTokenTwoSupply),
    },
    {
      unit: alwaysSuccessMintValidatorHash + stringToHex("myTokenOne"),
      quantity: String(myTokenOneSupply),
    },
    {
