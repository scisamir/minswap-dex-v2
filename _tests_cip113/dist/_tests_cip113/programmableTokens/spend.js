import { deserializeAddress, serializeAddressObj, scriptAddress, } from "@meshsdk/core";
...
const programmableLogicGlobalScriptHash = protocolBoostrap.programmableLogicBaseParams.scriptHash;
// --- Addresses & Credentials ---
// User's smart wallet address
const smartWalletAddr = serializeAddressObj(scriptAddress(programmableLogicGlobalScriptHash, wallet1SK), 0);
const sAddr = "addr_test1zreps2cq5daaw3hzq46untcp4vcnzgsn29xdx8589c9z50ss5qwgajhq0g92xjfuz4w7fjpztpd47thujf2rly7n03jsfsj8xj";
const deserializeSAddr = deserializeAddress(sAddr);
console.log(`sAddr: ${deserializeSAddr.pubKeyHash}; ${deserializeSAddr.scriptHash}; ${deserializeSAddr.stakeCredentialHash}; ${deserializeSAddr.stakeScriptCredentialHash}`);
console.log("programmableLogicGlobalScriptHash:", programmableLogicGlobalScriptHash);
console.log("wallet1VK:", wallet1VK);
console.log("wallet1SK:", wallet1SK);
console.log("smartWalletAddr:", smartWalletAddr);
const smartWalletAddrUtxos = await blockchainProvider.fetchAddressUTxOs(smartWalletAddr);
...
const testUtxos = await blockchainProvider.fetchAddressUTxOs("addr_test1qztvhvnujmd03j4cjr0x6lu87hlaqfdl3tyqw97tcnaw0kk5wsnj53x9v8dhupg6v8rzt48atr6zmrvlppkam7upd29sqeutm7");
console.log("testUtxos:", testUtxos);
