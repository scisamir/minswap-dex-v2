...
import { AdaAssetA, AdaRemainingLiquidity, AdaTotalLiquidity, NETWORK_ID, authenAddress, authenPolicyId, baseScript, blockchainProvider, calculate_amount_out, orderScriptTxHash, orderScriptTxIndex, orderValidatorAddress, orderValidatorRewardAddress, orderValidatorScriptHash, poolAuthAssetName, poolBatchingScriptTxHash, poolBatchingScriptTxIndex, poolBatchingValidatorHash, poolBatchingValidatorRewardAddress, poolScriptTxHash, poolScriptTxIndex, poolValidatorAddress, poolValidatorRewardAddress, poolValidatorScriptHash, sTokenAdaLpAssetName, sTokenAssetB, sTokenUnit, txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1Utxos, wallet1VK, } from "./setup.js";
...
const isSellOrder = Number(orderDatum.fields[6].fields[0].constructor) === 0 ? true : false;
if (!isSellOrder)
...
const assetAAmount = calculate_amount_out(oldPoolSTokenSupply, oldPoolAdaTokenSupply, orderSwapAmount, baseFeeANumerator);
