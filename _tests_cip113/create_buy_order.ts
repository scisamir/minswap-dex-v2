...
import { alwaysSuccessMintValidatorHash, authenPolicyId, orderLovelaceAmount, orderValidatorAddress, AdaSwapAmount, txBuilder, wallet1, wallet1Address, wallet1Collateral, wallet1SK, wallet1Utxos, wallet1VK, cip113ValidatorHash, usdcAdaLpAssetName } from "./setup.js"
