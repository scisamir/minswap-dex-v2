 ...
 */
import { applyParamsToScript, resolveScriptHash, serializeRewardAddress, serializePlutusScript, serializeAddressObj, scriptAddress, byteString, conStr0, conStr1, integer, } from "@meshsdk/core";
...
export { blueprint };
export const getValidator = (title) => {
...
// ─────────────────────────────────────────────────────────────────────────────
export const BLACKLIST_SEED_TX_HASH = "175590ef834a406774e889032e5996a208c67a575688c1414e5b4049d8eb4efd";
export const BLACKLIST_SEED_TX_INDEX = 2;
export const BLACKLIST_MINT_HASH = "ba7ed916a5e3ee12f41573abbfc1f05f02ca833411f373146d62015a";
// ─────────────────────────────────────────────────────────────────────────────
// STEP 2 OUTPUT — fill in after mintTokens.ts
// ─────────────────────────────────────────────────────────────────────────────
export const TOKEN_POLICY_ID = "ec107b98e0026f9c8a4a010eaa9d1ca81aa53c0d862e5cb488f1cf85";
...
// ─────────────────────────────────────────────────────────────────────────────
// protocolParams
export const protocolParamsPolicyId = "872cf2039513edce5e075f50d64091c8b2820fa85b4466c78bf14c16";
export const protocolParamsTxHash = "76884b2a51661740e4b962f4df22afc7193925f0c36aa170d820a7c2f55ad396";
export const protocolParamsTxIndex = 0;
// programmable_logic_global
export const globalHash = "5db48c6383a98a53ca163e58c0f8c9dbc932d65ba070daff97851282";
export const globalRewardAddr = serializeRewardAddress(globalHash, true, NETWORK_ID);
// programmable_logic_base
export const baseHash = "f2182b00a37bd746e20575c9af01ab31312213514cd31e872e0a2a3e";
// issuance_cbor_hex_mint
export const issuanceScriptHash = "40fc248b95c0b23a4c40524dd1b0a41d6c13225c6fa9867a4d44c94d";
// registry_mint (directoryMint)
export const registryMintPolicyId = "defddf7a98b92de4aa68f995d0e235ae21afd7a4757797ec6c27bafd";
export const directoryMintTxHash = "76884b2a51661740e4b962f4df22afc7193925f0c36aa170d820a7c2f55ad396";
export const directoryMintTxIndex = 0;
// registry_spend (directorySpend)
export const directorySpendHash = "e227ef2a34e5ec0f6c739b649daf50552912e60bb380aa3c5a4e4772";
...
// ─────────────────────────────────────────────────────────────────────────────
export const blacklistSpendCbor = applyParamsToScript(getValidator("blacklist_spend.blacklist_spend.spend"), [byteString(BLACKLIST_MINT_HASH)], "JSON");
export const blacklistSpendScript = {
    code: blacklistSpendCbor,
    version: "V3",
};
export const blacklistSpendAddr = serializePlutusScript(blacklistSpendScript, undefined, NETWORK_ID, false).address;
// ─────────────────────────────────────────────────────────────────────────────
// TRANSFER LOGIC — freeze_and_seize_transfer(Script(baseHash), blacklistMintHash)
// ─────────────────────────────────────────────────────────────────────────────
export const transferLogicCbor = applyParamsToScript(getValidator("example_transfer_logic.freeze_and_seize_transfer.withdraw"), [conStr1([byteString(baseHash)]), byteString(BLACKLIST_MINT_HASH)], "JSON");
...
// ─────────────────────────────────────────────────────────────────────────────
export const adminContractCbor = applyParamsToScript(getValidator("example_transfer_logic.example_transfer_logic.withdraw"), [conStr0([byteString(wallet1VK)])], // VerificationKey(adminPkh)
"JSON");
...
// ─────────────────────────────────────────────────────────────────────────────
export const issuanceCbor = applyParamsToScript(getValidator("issuance_mint.issuance_mint.mint"), [conStr1([byteString(baseHash)]), conStr1([byteString(adminContractHash)])], "JSON");
...
export const validateConfig = () => {
    ...
    if (registryMintHash !== registryMintPolicyId) {
        console.warn("⚠️  WARNING: registryMintHash !== registryMintPolicyId — blueprint may not match on-chain deployment");
    }
};
