import { authenPolicyId, factoryAddress, orderValidatorAddress, orderValidatorScriptHash, poolBatchingValidatorHash, poolValidatorAddress, poolValidatorScriptHash, userCip113Addr, } from "../setup.js";
import { TOKEN_POLICY_ID, baseHash, validateConfig, whitelistPolicyId, } from "./config.js";
import { purrfluidAdaLpAssetName, purrfluidUnit, } from "./dexConfig.js";
validateConfig();
