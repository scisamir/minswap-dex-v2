...
export const WHITELIST_SEED_TX_HASH =
  "0ecd431ab87e1cadf55c1f80dadb594c663baf821b556d8807a1d874efc6bb81";
...
const bootstrap = protocolBootstrap as any;
...
export const protocolParamsTxIndex =
  bootstrap.protocolParams.txInput.outputIndex;
...
export const globalCbor = applyParamsToScript(
  getBaseValidator(
...
export const directoryMintTxIndex =
  bootstrap.directoryMintParams.txInput.outputIndex;
...
export const registrySpendCbor = applyParamsToScript(
